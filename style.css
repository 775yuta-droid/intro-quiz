...
:root {
  ...
  --glow: 0 0 50px rgba(255, 79, 125, 0.6);
  --glow2: 0 0 50px rgba(0, 240, 255, 0.5);
}
...
.title-logo {
  ...
  filter: drop-shadow(0 0 30px rgba(255, 60, 110, 0.5));
}
...
.start-btn {
  margin-top: 24px;
  padding: clamp(16px, 3vh, 24px) clamp(40px, 8vw, 80px);
  font-family: "Bebas Neue", sans-serif;
...
.start-btn:hover {
  ...
  box-shadow: 0 0 60px rgba(255, 60, 110, 0.6);
}
.start-btn:active {
...
.q-counter {
  ...
  color: var(--accent);
  text-shadow:
    0 0 60px rgba(255, 60, 110, 0.6),
    0 0 120px rgba(255, 60, 110, 0.3);
  position: relative;
}
...
.wave-bar {
  ...
  border-radius: 4px;
  animation: waveBounce var(--dur, 0.8s) ease-in-out infinite alternate;
...
.yt-wrap {
  width: 100%;
  max-width: min(960px, calc(45vh * 16 / 9));
  margin: 0 auto;
  aspect-ratio: 16/9;
  border-radius: 8px;
  overflow: hidden;
...
/* ========== NEXT BUTTON ========== */
.next-btn {
  padding: clamp(12px, 2vh, 16px) clamp(24px, 5vw, 48px);
  font-family: "Bebas Neue", sans-serif;
...
.play-btn:hover {
  transform: scale(1.1);
  box-shadow: 0 0 60px rgba(255, 60, 110, 0.7);
}
...
/* ========== SECTION LABEL ========== */
.section-pill {
  padding: clamp(6px, 1.5vh, 12px) clamp(20px, 4vw, 40px);
  border-radius: 100px;
...
.skip-ans-btn {
  ...
  border-radius: 4px;
  color: var(--muted);
  padding: clamp(8px, 2vw, 16px) clamp(24px, 5vw, 48px);
  cursor: pointer;
  font-size: clamp(14px, 3vw, 24px);
  letter-spacing: 0.15em;
  font-family: "Noto Sans JP", sans-serif;
